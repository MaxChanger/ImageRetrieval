...
def train(config):
    ...
    for i in range(config["num_iterations"]):
        ...
        print("Iter: {:05d}, loss: {:.3f}".format(i, similarity_loss.float().item()))
...
if __name__ == "__main__":
    ...
    # train config  
    config = {}
    config["num_iterations"] = 5000     #10000
    config["snapshot_interval"] = 500   #3000
    ...
    if config["dataset"] == "imagenet":
        ...
        config["data"] = {"train_set1":{"list_path":"/home/sun/WorkSpace/HashCode/HashNet/pytorch/data/cifar10/train.txt", "batch_size":16}, \
                          "train_set2":{"list_path":"/home/sun/WorkSpace/HashCode/HashNet/pytorch/data/cifar10/train.txt", "batch_size":16}}
    print(config["loss"])
    train(config)
