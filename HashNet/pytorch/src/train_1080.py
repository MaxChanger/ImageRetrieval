...
if __name__ == "__main__":
    ...
    if config["dataset"] == "imagenet":
        config["data"] = {"train_set1":{"list_path":"/opt/database/imagenet/train.txt", "batch_size":36}, \
                          "train_set2":{"list_path":"/opt/database/imagenet/train.txt", "batch_size":36}}
        ...
        config["data"] = {"train_set1":{"list_path":"../data/cifar10/train.txt", "batch_size":36}, \
                          "train_set2":{"list_path":"../data/cifar10/train.txt", "batch_size":36}}
    print(config["loss"])
    train(config)
