...
if __name__ == '__main__':
    ...
    if FLAGS.task == 'calc_crop':
        ...
        if FLAGS.ignore_single_point:
            mask_search_path = r'/media/Data/Data02/Datasets/Mammogram/INbreast/calc_mask_ignore_single_point/*png'
        else:
            mask_search_path = r'/media/Data/Data02/Datasets/Mammogram/INbreast/calc_mask/*png'
        ...
        output_dir = '/data/log/mammo/mass_patches'
